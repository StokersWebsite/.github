...
>#### The most answered feature to the question "What would you like to have on the website" the most comon answer was to see the upcomming activities. So this was my main priority. So now the main feature of the website is the activities tab, on here you can see all the stokers activities and "join" so the organisers know how many people are going to come. If you are a stokers member and not just a user of the website you can also add an activity. For example if you are going to throw a carnaval related party of some sorts you can create this as an activity on the website.
>#### Another item on the frontend is the YouTube video's. the stokers created a song cover and a carnavals press confrence, which you can see on the website. 
>
